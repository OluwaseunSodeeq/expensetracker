...
$latterWithin.onclick = function(){
    ...
    if (allInputs[0].value.trim() === "" ||
        allInputs[1].value === "" ||allInputs[1].value <= 0 ||
        allInputs[2].value === ""){
        return alert(" Fields are not properly filled, \n kindly check and do the needful!")
      }
      ...
      document.querySelector('.total').innerHTML +=  newExpense($firstInput,$secondInput,$thirdInput);
      $inputList.style.display = "none";
